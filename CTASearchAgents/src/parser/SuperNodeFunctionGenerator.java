...
public class SuperNodeFunctionGenerator {
	private static ActionsFunction _ActionsFunction = null;
	private static ResultFunction _ResultFunction = null;
	private static GoalTest _GoalFunction = null;
	private Arc relations;
	String goal;
	
	SuperNodeFunctionGenerator(String goal, Arc relations){
		this.goal = goal;
	...
	private static class getStops implements ActionsFunction {
		private Arc relations;
	...
	private static class getResults implements ResultFunction {
		private Arc relations;
